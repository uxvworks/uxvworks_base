...
enum  optionIndex { UNKNOWN, HELP, VERSION, OPTIONAL, REQUIRED, NUMERIC, NONEMPTY };
const option::Descriptor usage[] = {
    {
        UNKNOWN, 0,"", "",       Arg::Unknown,  "USAGE: cppbase [options]\n\n"
        "Options:"
    },
    { HELP,    0,"h", "help",    Arg::None,     "  -h,        \t--help     \tPrint usage and exit." },
    { VERSION, 0,"v", "version", Arg::None,     "  -v,        \t--version  \tPrint version and exit." },
    {
